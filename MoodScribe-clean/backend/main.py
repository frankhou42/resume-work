...
SESSIONID = os.environ.get("IG_SESSIONID", "")  # provide via env var; never commit a real token
THREADID = None
VERBOSE = False
FILE_PATH = os.environ.get("MOODSCRIBE_DATAFILE", "dataFile.txt")
...
def main():
    ...
    with open(FILE_PATH, 'r') as file:
        ...
        output_directory = os.environ.get("MOODSCRIBE_OUTDIR", ".")
